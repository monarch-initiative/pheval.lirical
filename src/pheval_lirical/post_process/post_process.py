...
def post_process_results_format(input_dir: Path, testdata_dir: Path, output_dir: Path, config: LiricalConfig):
    """Create pheval gene result from LIRICAL tsv output."""
